...
<html lang="es">
    ...
    <body>
        ...
        <main>            
             ...
             * @authorOriginal Carlos García Cachón
             * @version 1.2
             * @since 30/10/2023
             */
            ...
            if (isset($_REQUEST['enviar'])) {
                ...
                $aErrores = [
                    ...
                    'colorOpcional' => validacionFormularios::validarColorHexadecimal($_REQUEST['colorOpcional'], OPCIONAL),
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="error">
                                        <?php
                                        if (!empty($aErrores['alfabeticoOpcional'])) {
                                            echo $aErrores['alfabeticoOpcional'];
                                        }
                                        ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['alfanumericoObligatorio'])) {
        echo $aErrores['alfanumericoObligatorio'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['alfanumericoOpcional'])) {
        echo $aErrores['alfanumericoOpcional'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
    ...
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                ...
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['enteroOpcional'])) {
        echo $aErrores['enteroOpcional'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['floatObligatorio'])) {
        echo $aErrores['floatObligatorio'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['floatOpcional'])) {
        echo $aErrores['floatOpcional'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
                                        <?php
                                        if (!empty($aErrores['correoObligatorio'])) {
                                            echo $aErrores['correoObligatorio'];
                                        }
                                        ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
                                        <?php
                                        if (!empty($aErrores['correoOpcional'])) {
                                            echo $aErrores['correoOpcional'];
                                        }
                                        ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['urlObligatorio'])) {
        echo $aErrores['urlObligatorio'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['urlOpcional'])) {
        echo $aErrores['urlOpcional'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
    ...
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                ...
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['fechaOpcional'])) {
        echo $aErrores['fechaOpcional'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['dniObligatorio'])) {
        echo $aErrores['dniObligatorio'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['dniOpcional'])) {
        echo $aErrores['dniOpcional'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
                                        <?php
                                        if (!empty($aErrores['cpObligatorio'])) {
                                            echo $aErrores['cpObligatorio'];
                                        }
                                        ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
                                        <?php
                                        if (!empty($aErrores['cpOpcional'])) {
                                            echo $aErrores['cpOpcional'];
                                        }
                                        ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['passwordObligatorio'])) {
        echo $aErrores['passwordObligatorio'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['passwordOpcional'])) {
        echo $aErrores['passwordOpcional'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['telefonoObligatorio'])) {
        echo $aErrores['telefonoObligatorio'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['telefonoOpcional'])) {
        echo $aErrores['telefonoOpcional'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['fileObligatorio'])) {
        echo $aErrores['fileObligatorio'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
                                                    <?php
                                                    if (!empty($aErrores['fileOpcional'])) {
                                                        echo $aErrores['fileOpcional'];
                                                    }
                                                    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['colorOpcional'])) {
        echo $aErrores['colorOpcional'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['rangeOpcional'])) {
        echo $aErrores['rangeOpcional'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>                                                                                                
                                        <select class="obligatorio" name="listaObligatorio">
                                            <option value="listItem1" <?php
                                        if (isset($_REQUEST['listaObligatorio'])) {
                                            echo 'selected';
                                        }
                                        ?>>listItem1</option> <!-- Si el campo es correcto se queda seleccionado. -->
                                            <option value="listItem2" <?php
                                        if (isset($_REQUEST['listaObligatorio'])) {
                                            echo 'selected';
                                        }
                                        ?>>listItem2</option> <!-- Si el campo es correcto se queda seleccionado. -->
                                            <option value="listItem3" <?php
                                    if (isset($_REQUEST['listaObligatorio'])) {
                                        echo 'selected';
                                    }
                                    ?>>listItem3</option> <!-- Si el campo es correcto se queda seleccionado. -->
                                        </select> 
                                    </td>
                                    <td class="error">
                                            <?php
                                ...
                                <tr>
                                    ...
                                    <td class="obligatorio">                                                                                                
                                        <input type="radio" id="radioButtonItem1" name="radioButtonObligatorio" value="radioButtonItem1" <?php
                                            if (is_null($aErrores['radioButtonObligatorio']) && isset($_REQUEST['radioButtonObligatorio']) && $_REQUEST['radioButtonObligatorio'] == 'radioButtonItem1') {
                                                echo 'checked';
                                            }
                                            ?>> <!-- Si el campo es correcto se queda seleccionado. -->
                                        <label for="radioButtonObligatorio">radioButtonItem1</label>
                                        <input type="radio" id="radioButtonItem2" name="radioButtonObligatorio" value="radioButtonItem2" <?php
    ...
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                ...
                                <tr>
                                    ...
                                    <td class="obligatorio">                                                                                                
                                        <input type="checkbox" id="cbItem1" name="checkBoxObligatorio[cbItem1]" value="cbItem1" <?php
    if (isset($_REQUEST['checkBoxObligatorio']['cbItem1'])) {
        echo 'checked';
    }
    ?>> <!-- Si el campo es correcto se queda seleccionado. -->
                                        <label for="cbItem1">cbItem1</label>
                                        <input type="checkbox" id="cbItem2" name="checkBoxObligatorio[cbItem2]" value="cbItem2" <?php
    if (isset($_REQUEST['checkBoxObligatorio']['cbItem2'])) {
        echo 'checked';
    }
    ?>> <!-- Si el campo es correcto se queda seleccionado. -->
                                        <label for="cbItem2">cbItem2</label>
                                        <input type="checkbox" id="cbItem3" name="checkBoxObligatorio[cbItem3]" value="cbItem3" <?php
    if (isset($_REQUEST['checkBoxObligatorio']['cbItem3'])) {
        echo 'checked';
    }
    ?>> <!-- Si el campo es correcto se queda seleccionado. -->
                                    ...
                                    <td class="error">
    <?php
    if (!empty($aErrores['checkBoxObligatorio'])) {
        echo $aErrores['checkBoxObligatorio'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>                                                                                                    <!-- En el siguiente 'if' comprobamos que en el array '$aErrores' , guarde valor 'NULL' y que la variable ese declarada y sin 
                                        ...
                                        <textarea class="obligatorio d-flex justify-content-start" rows="4" cols="50" name="textAreaObligatorio" placeholder="cadena_de_letras_y_numeros"><?php
    ...
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                ...
                                <tr>
                                    ...
                                    <td>                                                                                                    <!-- En el siguiente 'if' comprobamos que en el array '$aErrores' , guarde valor 'NULL' y que la variable ese declarada y sin 
                                        ...
                                        <textarea class="d-flex justify-content-start" rows="4" cols="50" name="textAreaOpcional" placeholder="cadena_de_letras_y_numeros"><?php
    if ($aErrores['textAreaOpcional'] == null && isset($_REQUEST['textAreaOpcional'])) {
        echo ($_REQUEST['textAreaOpcional']);
    }
    ?></textarea>
                                    </td>
                                    <td class="error">
    <?php
    if (!empty($aErrores['textAreaOpcional'])) {
        echo $aErrores['textAreaOpcional'];
    }
    ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                    </td>
                                </tr>
